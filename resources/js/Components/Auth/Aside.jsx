...
const Aside = ({ isOpen, user, userType, mentor }) => {
    ...
    return (
        <aside
            className={`fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'
        ...
        >
            ...
            >
                ...
                {languageDropdown && (
                    <div className="absolute bottom-16 z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                            ...
                            <li>
                                ...
                                >
                                    <div className="inline-flex items-center ">
                                        <svg
                                            aria-hidden="true"
                                            className="h-3.5 w-3.5 rounded-full mr-2 shadow-md"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 512 512"
                                        >
