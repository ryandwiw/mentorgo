...
export default function SessionCard({ session, hasActiveBooking, hasCanceledBooking, onOpenModal, isProfileComplete, totalClassesCreated }) {
                ...
                <div className='bg-white m-3 p-4 shadow-courses rounded-2xl max-w-sm mx-auto'>
                    <div className="relative rounded-3xl">
                        {session.subject && session.subject.profile_matkul && (
                            <img
                                className="m-auto clipPath w-full h-44 object-cover"
                        ...
                        {!(hasCanceledBooking || hasActiveBooking) && (
                            <div className="absolute right-5 -bottom-2 bg-ultramarine rounded-full p-6">
                                ...
                                <button
                                    ...
                                    className="text-white uppercase text-center text-sm font-medium block"
                                    disabled={processing}
                                >
                        ...
                        <div className="flex justify-between pt-6">
                            <div className="flex gap-4">
                                ...
                                <Link
                                    ...
                                    className="text-base font-medium text-black opacity-75"
                                >
                                    Lihat Detail
                                </Link>
                            </div>
