// resources/js/Pages/mentors/Settings.jsx
...
export default function Settings({ mentor }) {
    return (
        <AuthLayout>
            <div className="container mx-auto px-4 ">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-md p-6 mb-6 text-center">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden ">
                        ...
                        <Link href={route('mentor.delete', mentor.slug)} method="delete" className="flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
                            <div className="flex items-center">
                        ...
                        <Link href={route('mentor.logout')} method="post" className="flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
                            <div className="flex items-center">
